#ifndef __HRSMULTSCATT_HH
#define __HRSMULTSCATT_HH
...
class HRSMultScatt {
    ...
    public:
	HRSMultScatt();
	HRSMultScatt( double p, double t, double A, double Z );
	HRSMultScatt( double p, int nmat, double t[], double A[], double Z[] );

	void   Init( double p, double t, double A, double Z );
	void   Init( double p, int nmat, double t[], double A[], double Z[] );

	virtual ~HRSMultScatt() {;}
