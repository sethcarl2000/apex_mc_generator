...
private: //commands
  ...
  std::unique_ptr<G4UIcmdWithADoubleAndUnit>  sieveYHighCmd;
  std::unique_ptr<G4UIcmdWithADoubleAndUnit>  sieveYLowCmd;

  std::unique_ptr<G4UIcmdWithADoubleAndUnit>  gunXHighCmd;
  std::unique_ptr<G4UIcmdWithADoubleAndUnit>  gunXLowCmd;
