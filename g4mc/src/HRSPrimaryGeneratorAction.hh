...
private:
  ...
  G4double gunX,gunY,gunZ;
  G4double gunXLow,gunXHigh, gunYLow,gunYHigh, gunZLow,gunZHigh;
  double gunSieveXLow,gunSieveXHigh, gunSieveYLow,gunSieveYHigh; 
...
*/
  ...
  //Gun Hi-lo limits for uniform generation 
  //settters -
  inline void SetGunSieveXLow (G4double val) { gunSieveXLow  = val; }
  inline void SetGunSieveXHigh(G4double val) { gunSieveXHigh = val; }

  inline void SetGunSieveYLow (G4double val) { gunSieveYLow  = val; }
  inline void SetGunSieveYHigh(G4double val) { gunSieveYHigh = val; }
  
  inline void SetGunXLow (G4double val) { gunXLow  = val; }
  inline void SetGunXHigh(G4double val) { gunXHigh = val; }

  inline void SetGunYLow (G4double val) { gunYLow  = val; }
  inline void SetGunYHigh(G4double val) { gunYHigh = val; }
  
  inline void SetGunZLow (G4double val) { gunZLow  = val; }
  inline void SetGunZHigh(G4double val) { gunZHigh = val; }
  
  //getters 
  inline double GetGunSieveXLow () const { return gunSieveXLow;  }
  inline double GetGunSieveXHigh() const { return gunSieveXHigh; }

  inline double GetGunSieveYLow () const { return gunSieveYLow;  }
  inline double GetGunSieveYHigh() const { return gunSieveYHigh; }

  inline double GetGunXLow () const { return gunXLow;  }
  inline double GetGunXHigh() const { return gunXHigh; }

  inline double GetGunYLow () const { return gunYLow;  }
  inline double GetGunYHigh() const { return gunYHigh; }
  
  inline double GetGunZLow () const { return gunZLow;  }
  inline double GetGunZHigh() const { return gunZHigh; }
