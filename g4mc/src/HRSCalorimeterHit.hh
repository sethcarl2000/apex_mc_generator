// ********************************************************************
//
// $Id: HRSCalorimeterHit.hh,v 1.0, 2010/12/26 HRS Exp $
// --------------------------------------------------------------
//

//
#ifndef HRSCalorimeterHit_h
#define HRSCalorimeterHit_h 1
...
class HRSCalorimeterHit : public G4VHit
{
public:

	HRSCalorimeterHit(G4int i,G4double t);
	virtual ~HRSCalorimeterHit();
	HRSCalorimeterHit(const HRSCalorimeterHit &right);
	const HRSCalorimeterHit& operator=(const HRSCalorimeterHit &right);
	int operator==(const HRSCalorimeterHit &right) const;
...
typedef G4THitsCollection<HRSCalorimeterHit> HRSCalorimeterHitsCollection;

extern G4Allocator<HRSCalorimeterHit> HRSCalorimeterHitAllocator;

inline void* HRSCalorimeterHit::operator new(size_t)
{
	void* aHit;
	aHit = (void*)HRSCalorimeterHitAllocator.MallocSingle();
	return aHit;
}

inline void HRSCalorimeterHit::operator delete(void*aHit)
{
	HRSCalorimeterHitAllocator.FreeSingle((HRSCalorimeterHit*) aHit);
}
