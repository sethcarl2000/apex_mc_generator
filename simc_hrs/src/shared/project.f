...
C I am commenting this out, because I cannot find wherever this function is defined.
C       Also, this block is currently unreachable, as the 'decay_flag=false' is hard-coded
C       in mc_hrs_single.f.
 	    
C	    call loren(gamma,bx,by,bz,er,pxr,pyr,pzr,ef,pxf,pyf,pzf,pf)
	    dxdzs = pxf/pzf
	    dydzs = pyf/pzf
