...
C I am commenting this call to 'loren', which is presumably a lorenz transformation
C  fcn, beacuse I am not going to use the decay flag. 	    
...
C    SOS: if spectr = 2
	...
	if (spectr.eq.1) then
	  ...
	  file_name='src/hrs_forward_cosy.dat'
