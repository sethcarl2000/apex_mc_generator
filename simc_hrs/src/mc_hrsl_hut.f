...
C       
C	I'm commenting this, because I don't have the external 'gauss1' lib function,
C       And I don't want to do smearing anyway. - Seth H. 2 Jul 2025
C       
C	if(wcs_flag) then
C	   tmpran1 = gauss1(nsig_max)
